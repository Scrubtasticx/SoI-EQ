 ...
 #   "Cleric" => 20076 , 
  #  "Paladin" => 48147 , 
   # "Ranger" => 62649, 
	...
	my $TextToCenter2 = plugin::PWAutoCenter("We are a solo/duo server that has tons of custom NPCs in our hub. For link to our website for spell file and forums. Click the discord link below");
	my $TextToCenter3 = plugin::PWAutoCenter("");
	my $TextToCenter4 = plugin::PWAutoCenter("We are still in alpha. Tons more things to come! everyone can use #zone, MQ2 is not allwed here in anyway.");
	my $Indent = plugin::PWIndent();
	my $TextToCenter5 = plugin::PWAutoCenter("");
	my $TextToCenter6 = plugin::PWAutoCenter("Alpha Phase");
	...
	<br><br>
	$Blu $TextToCenter4 </c> <br>
	<br><br>
	$Red $TextToCenter6 </c> <br>
