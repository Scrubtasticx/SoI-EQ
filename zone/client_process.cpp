...
void Client::OnDisconnect(bool hard_disconnect) {
	...
	//Zycron Logout message
	if (!bZoning)
		worldserver.SendEmoteMessage(nullptr, 0, 0, Chat::Broadcasts, "%s has disconnected from the server.", GetCleanName());
	//Zycron Logout message end
